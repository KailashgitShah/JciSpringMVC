			  ...
			  <div class="page-content fade-in-up">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                       ...
                       <h2 style="text-align:center;">3rd Level Available (DPC Wise)</h2><br>  
				  <div class="row">
                      <%
				 ...
				 <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
								...
								<caption>3rd Level view of Procured Jute DPC Wise</caption>
						            ...
						            double sumGrade6 = 0;
						            double sumGrade7 = 0;
								  int size = dpc_procured.size();
								for (int i = 0; i < size; i++) {
								    InventoryDTO procured = dpc_procured.get(i);
								    InventoryDTO available = dpc_available.get(i);
								
								%>
								<tbody>	
									<tr>
										<td>(<%=i+1%>)</td>
										<td id="<%=i%>regionname"><%=available.getRoname()%></td>
										<td id="<%=i%>grade0"><%=procured.getGrade1() - available.getGrade1()%></td>
										<td id="<%=i%>grade1"><%=procured.getGrade2() - available.getGrade2()%></td>
										<td id="<%=i%>grade2"><%=procured.getGrade3() - available.getGrade3()%></td>
										<td id="<%=i%>grade3"><%=procured.getGrade4() - available.getGrade4()%></td>
										<td id="<%=i%>grade4"><%=procured.getGrade5() - available.getGrade5()%></td>
										<td id="<%=i%>grade5"><%=procured.getGrade6() - available.getGrade6()%></td>
										<td id="<%=i%>grade6">0.0</td>
										<td id="<%=i%>grade7">0.0</td>
										<td id="<%=i%>total"><%=procured.getGrade7() - available.getGrade7()%></td>
						   ...
						   <%
						   sumGrade1 += procured.getGrade1() - available.getGrade1();
			                sumGrade2 += procured.getGrade2() - available.getGrade2();
			                sumGrade3 += procured.getGrade3() - available.getGrade3();
			                sumGrade4 += procured.getGrade4() - available.getGrade4();
			                sumGrade5 += procured.getGrade5() - available.getGrade5();
			                sumGrade6 += procured.getGrade6() - available.getGrade6();
			                sumGrade7 += procured.getGrade7() - available.getGrade7();
								}
						   %>
						   <tfoot>
						        <tr>
