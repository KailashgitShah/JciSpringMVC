...
<body class="fixed-navbar" onload="myFunction()">
                ...
                <div class="row">
                    <div class="col-md-11">
                        <div class="ibox">
                          <span>${msg}</span>
                            <div class="ibox-body">
                       <form action="editcreationofbid.obj" method="POST">
   ...
   <div class="col-sm-4 form-group">
    <input type="checkbox" id="provisionofclaim" name="provisionofclaim" onclick="return false;" <% if(list.get(0)[12].equals(0)) out.print("checked"); %> disabled>
                ...
                %>">
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="col-sm-4 form-group">
                                                    ...
                                                    <input class="form-control taxtbox" name="SecurityDepositAmount" id="SecurityDepositAmount" min="0" type="number" placeholder="Security Deposit Amount" required readonly value="<%= list.get(0)[13] %>">
                                              </div>
                                   
                                    <div class="col-sm-4 form-group">
                                                    <label class="required">Days to Accept</label>
                                                    <input class="form-control taxtbox" name="DaystoAccept" id="DaystoAccept" min="0" type="number" placeholder="Days to Accept" readonly value="<%= list.get(0)[14] %>" required >
                                              </div>
                               
                                  <div class="col-sm-4 form-group">
                                                                                              <label class="required">Days to deposit</label>
                                                                                                <input class="form-control taxtbox" name="daystodeposit" id ="daystodeposit"min="0"  type="number"  placeholder="Days to deposit" value="<%= list.get(0)[9] %>" readonly required >
                                                                                            </div> 
                                    ...
                                    <div class="row">
                                               ...
                                               <div class="col-sm-4 form-group">
                                                                                              <label>Delivery Period</label>
                                                                                                <input class="form-control taxtbox" name="Delivery_Period" id ="Delivery_Period"min="0"  type="number"  value="<%= list.get(0)[11] %>" readonly required >
                                                                                            </div> 
