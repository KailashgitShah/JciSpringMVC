			  ...
			  <div class="page-content fade-in-up">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                       ...
                       <h2 style="text-align:center;">3rd Level view Payment not received</h2><br>  
				  <div class="row">
                      <%
                      List<InventoryDTO> Contract_3rdLevel  = (List<InventoryDTO>)request.getAttribute("Contract_3rdLevel");
                      %>     
				 ...
				 <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
								...
								<thead>
								<caption>3rd Level view Payment not received</caption>
									<tr>
										<th>Sl.no</th>
								        <th>Contract No</th>
										<th>Loose</th>
								...
								<%
								int i = 0;
								for (InventoryDTO  Contract :Contract_3rdLevel) {
								
								%>
								<tbody>	
									<tr>
										<td>(<%=i+1%>)</td>
										<td id="<%=i%>regionname"><a href ="Contract4thLevel.obj?contractno=<%=Contract.getRoname()%>"><%=Contract.getRoname()%></a></td>
