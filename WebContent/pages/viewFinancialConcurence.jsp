...
<body class="fixed-navbar">
	<div class="page-wrapper">
		...
		<div class="content-wrapper">
			...
			<%
			List<FinancialConcurenceModel> allUserRegistration = (List<FinancialConcurenceModel>) request
					.getAttribute("financialConcurenceModel");
							...
							<table
								...
								<tbody>
									...
									<tr>
										...
										<td><a
											href="downloadFcdocument.obj?filename=<%=financialConcurenceModel.getFcdocumentDownload()%>">

												<button class="btn btn-primary btn-sm" target="_blank"
													type="button">View fc docs</button>
										</a></td>
										<%
										if (role_id == 51) {
										%>
										<td><a
											href="regenerateFcDocument.obj?fcNo=<%=financialConcurenceModel.getFC_Ref_No()%>&contract=<%=financialConcurenceModel.getFullcontractno()%>&allowedQty=<%=financialConcurenceModel.getQtyAllowed()%>">

												<button class="btn btn-warning btn-sm" target="_blank"
													type="button">Regenerate FC Doc</button>
										</a></td>
										<%
										}
										}
