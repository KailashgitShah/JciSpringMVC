...
.table3-cell {
       ...
       position: relative;
       /* Position relative for absolute positioning of inputs */
}

.table3-cell input[type="checkbox"], .table3-cell input[type="number"] {
                                                           ...
                                                           <div class="child-checkbox" id="disableform">
                                                                  <div class="row">
                                                                        ...
                                                                        <div class="col-sm-4 form-group">
                                                                               ...
                                                                               </span>&nbsp; <span id="Mill_name" name="MR_Date"
                                                                                     class="text-danger"> </span> <input class="form-control"
                                                                                     name="Mill_name" id="Mill_name" value="<%=millName%>"
                                                                                     readonly="readonly" required>
                                                                        </div>

                                                                        <div class="col-sm-4 form-group">
                                                                               <label>HO_DINO</label> <span class="text-danger">* </span>&nbsp;
                                                                               <span id="MR_Date" name="MR_Date" class="text-danger">
                                                                               </span> <input class="form-control" name="HO_DINO" id="HO_DINO1"
                                                                                     value="<%=hoDate%>" readonly="readonly" required>
                                                                        </div>
                                                                        <div class="col-sm-4 form-group">
                                                                               <label>Di_date</label> <span class="text-danger">* </span>&nbsp;
                                                                               <span id="MR_Date" name="MR_Date" class="text-danger">
                                                                               </span> <input class="form-control" name="diDate1" id="diDate"
                                                                  ...
                                                                  <div class="row">
                                                                        ...
                                                                        <div class="col-sm-4 form-group">
                                                                               ...
                                                                               </span>&nbsp; <span id="challanno2" name="challanno3"
                                                                                     class="text-danger"> </span> <input class="form-control"
                                                                                     name="challanno1" id="challanno4" value="<%=contractNo%>"
                                                                                     readonly="readonly" required>
                                                                        </div>
                                                                        <div class="col-sm-4 form-group">
                                                                               <label>Date of Shipment</label> <span class="text-danger">*
                                                                               </span>&nbsp; <span id="MR_Date" name="MR_Date" class="text-danger">
                                                                               </span> <input class="form-control" name="dateOfShipmentValue1"
                                                                                     id="dateOfShipmentValue" value="" readonly="readonly"
                                                                                     required>
                                                                        </div>
                                                                        <div class="col-sm-4 form-group">
                                                                               <label>Vehicle no</label> <span class="text-danger">*
                                                                               </span>&nbsp; <span id="Mill_name" name="MR_Date"
                                                                                     class="text-danger"> </span> <input class="form-control"
                                                                                     name="vehicleNo1" id="vehicleNo" value=""
                                                                                     readonly="readonly" required>
                                                                        </div>
                                     ...
                                     <div class="col-sm-4 form-group">
                                                                  ...
                                                                  <div class="row">
                                                                        ...
                                                                        <div class="col-sm-4 form-group">
                                                                               ...
                                                                               <input class="form-control" name="MR_No1" id="MR_No"
                                                                        ...
                                                                        <div class="col-sm-4 form-group">
                                                                               <label>MR Date</label> <span class="text-danger">* </span>&nbsp;
                                                                               <span id="MR_Date" name="MR_Date" class="text-danger">
                                                                               </span> <input class="form-control" name="MR_Date1" id="MR_Date1"
                                                                                     type="date" required>
                                                                        </div>
                                                                        <div class="col-sm-4 form-group">
                                                                  ...
                                                                  <div class="row">
                                                                        <div class="col-sm-4 form-group">
                                                                               <label>Contractno</label> <span class="text-danger">*
                                                                               </span>&nbsp; <span id="Contractno3" name="Contractno4"
                                                                                     class="text-danger"> </span> <input class="form-control"
                                                                                     name="Contractno" id="Contractno12" value="" readonly>
                                                                        </div>
                                                                  </div>
                                                                  ...
                                                                  <div class="table-container">
                                                                        <table id="childTable1" name="chilnametable1"
...
$(document).ready(function() {
    ...
    var contractNo = "<%=contractNo%>";
                                 ...
                                 $.ajax({
                                       ...
                                       success : function(data) {
                                              ...
                                              if (dataArray.length > 0) {
                                                    ...
                                                    var contNo1 = document
                                                                  .getElementById('Contractno12').value;

                                                    var challanno = document
                                                                  .getElementById('challanno4').value;
                                                    ...
                                                    $.ajax({
                                                           ...
                                                           success : function(data) {
                                                                  ...
                                                                  if (dataArray.length > 0) {
                                                                        ...
                                                                        resultsArray = dataArray[0]
                                                                                     .slice(0); // Copy the elements from dataArray[0] to resultsArray
                                                                        ...
                                                                        loadMillChildBasedData(contractNo,
             ...
             $("#Mill_receiptQty123").on("input", function() {
                    var mrQty = parseFloat($("#Mill_receiptQty123").val());
             console.log("mrQty:"+mrQty);
             /*     actQtyList.push(+row[7]);
                    sumOfActQty += +row[7]; */
                    
                    for(var i=0 ; i < actQtyList.length ; i++){
                          //alert("actQtyList"+i+actQtyList);
                var portion = actQtyList[i]/sumOfActQty;
                //console.log("portion:"+portion);
                //console.log("actQtyList"+actQtyList);
               // console.log("sumOfActQty:"+sumOfActQty); 
                var actQtyForRow = mrQty * parseFloat((portion).toFixed(6));
                
                //alert("actQtyForRow:"+actQtyForRow);
             ...
             $(document)
                          .ready(
                                       function() {
                                              ...
                                              $(document).on(
                                                           'change',
                                                           'input[id^="checkNcvPercentage"]',
                                                           function() {
                                                                  var checkbox = $(this);
                                                                  var tableRow = checkbox.closest('tr');
                                                                  var index = checkbox.attr('id')
                                                                               .replace('checkNcvPercentage',
                                                                                            '');
                                                                  var inputFields = tableRow
                                                                               .find('input[id="NCVamt_'
                                                                                            + index + '"]');
                                              ...
                                              $(document)
                                                           .on(
                                                                        'change',
                                                                        'input[id^="checkDustAMt_Percentage"]',
                                                                        function() {
                                                                               var checkbox = $(this);
                                                                               var tableRow = checkbox
                                                                                            .closest('tr');
                                                                               var index = checkbox
                                                                                            .attr('id')
                                                                                            .replace(
                                                                                                         'checkDustAMt_Percentage',
                                                                                                         '');
                                                                               var inputFields = tableRow
                                                                                            .find('input[name="DustAMt_[]"]');

                                                                               checkcondition = 1;
                                                                               toggleInputFields1(checkbox,
                                                                                            inputFields, index);
                                                                               if (checkbox.is(':checked')) {
                                                                                     tableRow.find(
                                                                                                  'input[id="DustQty_'
             ...
             $(document).ready(function() {
                    // Event listener for NCV amount input field
                    $(document).on('input', '[id^=NCVamt_]', function() {
                          var index = $(this).attr('id').split('_')[1]; // Extract index from id
                          if ($(this).val() !== '') {
                                 $('#ncvdust_' + index).val('0').prop('readonly', true);
                          } else {
                                 $('#ncvdust_' + index).prop('readonly', false);
                          }
                    });

                    // Event listener for NCV dust input field
                    $(document).on('input', '[id^=ncvdust_]', function() {
                          var index = $(this).attr('id').split('_')[1]; // Extract index from id
                          if ($(this).val() !== '') {
                                 $('#NCVamt_' + index).val('0').prop('readonly', true);
                          } else {
                                 $('#NCVamt_' + index).prop('readonly', false);
                          }
                    });

                    // Event listener for Dust amount input field
                    $(document).on('input', '[id^=DustAMt_]', function() {
                           var index = $(this).attr('id').split('_')[1]; // Extract index from id
                          if ($(this).val() !== '') {
                                 $('#DustQty_' + index).val('0').prop('readonly', true);
                          } else {
                                 $('#DustQty_' + index).prop('readonly', false);
                          }
                    });

                    // Event listener for Dust quantity input field
                    $(document).on('input', '[id^=DustQty_]', function() {
                          var index = $(this).attr('id').split('_')[1]; // Extract index from id
                          if ($(this).val() !== '') {
                                 $('#DustAMt_' + index).val('0').prop('readonly', true);
                          } else {
                                 $('#DustAMt_' + index).prop('readonly', false);
                          }
                    });
             });
             ...
             function toggleInputFields(checkbox, inputFields, index) {
                    ...
                    if (checkbox.attr('id').startsWith('checkNcvPercentage')) {
                           checkbox.closest('tr').find('input[id="NCVamt_' + index + '"]')
                                       .prop('disabled', !checkbox.is(':checked'));
                          checkbox.closest('tr')
                                        .find('input[id="ncvdust_' + index + '"]').prop(
                                                    'checked', checkbox.is(':checked')).prop(
                                                    'disabled', checkbox.is(':checked'));
                          checkbox.closest('tr').find(
                                       'input[id^="checkNcvQty_' + index + '"]').prop(
                                       'disabled', checkbox.is(':checked'));
                          // $('input[name="ncvdust[]"]').val('0'); // Commented out as it might not be necessary
                          if (!checkbox.is(':checked')) {
                                 checkbox.closest('tr').find(
                                              'input[id="NCVamt_' + index + '"]').val('');
                          }
                          ...
                          checkbox.closest('tr')
                                        .find('input[id="ncvdust_' + index + '"]').prop(
                                                    'disabled', !checkbox.is(':checked'));
                           checkbox.closest('tr').find('input[id="NCVamt_' + index + '"]')
                                       .prop('checked', checkbox.is(':checked')).prop(
                                                    'disabled', checkbox.is(':checked'));
                          checkbox.closest('tr').find(
                                        'input[id^="checkNcvPercentage_' + index + '"]').prop(
                                       'disabled', checkbox.is(':checked'));
                          // $('input[name="NCVamt[]"]').val('0'); // Commented out as it might not be necessary
                          if (!checkbox.is(':checked')) {
                                 checkbox.closest('tr').find(
                                              'input[name="ncvdust_' + index + '"]').val('');
                          }
                    } else {
             ...
             function toggleInputFields1(checkbox, inputFields, index) {
                    ...
                    if (checkbox.attr('id').startsWith('checkDustAMt_Percentage')) {
                          checkbox.closest('tr').find(
                                       'input[name="DustAMt_' + index + '"]').prop('disabled',
                                        !checkbox.is(':checked'));
                          checkbox.closest('tr').find(
                                       'input[name="DustQty_' + index + '"]').prop('checked',
                                        checkbox.is(':checked')).prop('disabled',
                                       checkbox.is(':checked'));
                          checkbox.closest('tr').find(
                                        'input[id^="checkDustQty_' + index + '"]').prop(
                                       'disabled', checkbox.is(':checked'));
                          // $('input[name="DustQty_[]"]').val('0'); // Commented out as it might not be necessary
                          if (!checkbox.is(':checked')) {
                                 checkbox.closest('tr').find(
                                              'input[name="DustAMt_' + index + '"]').val('');
                          }
                    } else if (checkbox.attr('id').startsWith('checkDustQty_')) {
                          checkbox.closest('tr').find(
                                       'input[name="DustQty_' + index + '"]').prop('disabled',
                                        !checkbox.is(':checked'));
                          checkbox.closest('tr').find(
                                       'input[name="DustAMt_' + index + '"]').prop('checked',
                                        checkbox.is(':checked')).prop('disabled',
                                       checkbox.is(':checked'));
                          checkbox.closest('tr').find(
                                        'input[id^="checkDustAMt_Percentage_' + index + '"]')
                                       .prop('disabled', checkbox.is(':checked'));
                          // $('input[name="DustAMt_[]"]').val('0'); // Commented out as it might not be necessary
                          if (!checkbox.is(':checked')) {
                                 checkbox.closest('tr').find(
                                              'input[name="DustQty_' + index + '"]').val('');
                          }
                    } else {
                          console.log('Unknown checkbox triggered.'); // Log if an unknown checkbox triggers the function
                    }
              ...
              <%--     var region1='<%=region %>'; --%>
                var region1=regionId;
                  ...
                  console.log(region1);
                    ...
                    let totalvalue = 0;
                    totalvalue = ncvValue + dustValue + moisturevalue + dustqty
                                 + ncvqty;
                    ...
                    if (qs < 1) {
                          ...
                          if (rem === 0) {
                                 ...
                                 totalvalue += parseFloat(valueinprice);
                                 totalvalue = Math.round(totalvalue);
                                 console.log('qs is 1, rem is 0, valueinprice:',
                                              valueinprice);
                                 ...
                                 totalvalue = Math.round(totalvalue);
                                 console.log('qs is 1, rem is not 0, valueinprice:',
                                              valueinprice1);
                          }
                    ...
                    document.getElementById('claimAmmount' + index).value = totalvalue
                                 .toFixed(2);
             }
       </script>
