			  ...
			  <div class="page-content fade-in-up">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                       ...
                       <h2 style="text-align:center;">2nd Level Procured (Region Wise)</h2><br>  
				  <div class="row">
                      <%
				 ...
				 <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
								...
								<tbody>	
									<tr>
										...
										<td id="<%=i%>grade2"><%=regionwise.getGrade3()%></td>
										<td id="<%=i%>grade3"><%=regionwise.getGrade4()%></td>
										<td id="<%=i%>grade4"><%=regionwise.getGrade5()%></td>
										<td id="<%=i%>grade5"><%=regionwise.getGrade6()%></td>
										<td id="<%=i%>grade6">0.0</td>
										<td id="<%=i%>grade7">0.0</td>
										<td id="<%=i%>total"><%=regionwise.getGrade7()%></td>
