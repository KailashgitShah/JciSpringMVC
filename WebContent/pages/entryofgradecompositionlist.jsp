...
<body class="fixed-navbar">
	<div class="page-wrapper">
		...
		<div class="content-wrapper">
			...
			<%
			List<EntryofGradeCompositionModel> egcList = (List<EntryofGradeCompositionModel>) request.getAttribute("egc");
			%>
							...
							<table class="table table-striped table-bordered table-hover"
								...
								<thead>
									<tr>
										...
										<th>Label Name</th>
										<th>Jute Variety</th>
										<th>System Composition</th>
										<th>Proposed Composition</th>
										<th></th>
								...
								<tbody>
									<%
									int i = 1;
									for (EntryofGradeCompositionModel egcl : egcList) {
									%>
									<tr>
										<td><%=i%></td>

										<td><%=egcl.getCrop_year()%></td>
										<td><%=egcl.getAvailable_qty()%></td>
										<td><%=egcl.getLabel_name()%></td>
										<td><%=egcl.getJute_combination()%></td>
