							...
							<table
								...
								<tbody>
									...
									<tr>
										...
										<td><a
											href="downloadPDF.obj?filename=<%=generationOfBillSupplyModel.getBos_file_path()%>"
										...
										%>
										<td><a
											href="regenerateBosDocument.obj?id=<%=generationOfBillSupplyModel.getBill_of_supply_no()%>"
											class="btn btn-warning btn-sm">Regenerate BOS</a></td>
