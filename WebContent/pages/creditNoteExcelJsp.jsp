	...
	<div class="page-wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="page-heading">
				<h1 class="page-title">Credit Note Excel</h1>
			</div>
				...
				<div class="row">
					<div class="col-md-11">
						<div class="ibox">
							<span>${msg}</span>
							<div class="ibox-body">
								<form id="myForm" action="downloadCreditNoteExcel.obj" method="POST" target="_blank">
									...
									<div class="row">
										...
										<div class="col-sm-4 form-group">
											<label>Bos Start Date</label> <input
												class="form-control taxtbox" id="startDate"
												name="startDate" placeholder="dd-mm-yyyy" required>
										</div>
										<div class="col-sm-4 form-group">
											<label>Bos End Date</label> <input
												class="form-control taxtbox" id="endDate"
												name="endDate" placeholder="dd-mm-yyyy" required>
										</div>
									</div>
