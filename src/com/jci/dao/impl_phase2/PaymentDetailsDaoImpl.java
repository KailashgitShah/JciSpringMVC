...
//	
	...
	public List<EntryPaymentDetailsModel> getAllPaymentInstruments() {
		...
		// String sql = "SELECT * FROM jcipayment_arrangement WHERE Fc_status = 0 or
		// Fc_status = 1 ";
		// String sql = "SELECT * FROM jcipayment_arrangement WHERE Fc_status = 0 and
		// Fc_status = 1 ";
...
//			+ "FROM jcipayment_arrangement\r\n";
	...
	public void update1(String cont_no, int paymentId, String remark) {
		...
		String hql = "UPDATE jcipayment_arrangement set Fc_status = 2,Fc_remarks='Rejected', Fc_action_date = '"
				+ dateString + "',Remarks='" + remark + "'  where Contract_No = '" + cont_no + "' and  Payment_id = '"
				+ paymentId + "' ";
	...
	public void update2(String cont_no) {
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
		String dateString = dateFormat.format(date);
		String hql = "UPDATE jcipayment_arrangement set Fc_status = 1,Fc_remarks='Accepted', Fc_action_date = '"
				+ dateString + "'  where Contract_No = '" + cont_no + "' ";
...
//				;
	...
	public void contratTable(String cont_no) {
		...
		try {
			...
			String hql = "UPDATE jcicontract set intial_payment_flag = 1 ,intial_payment_date= '" + dateTime
					+ "', contract_status='Payment Done' where Contract_no = '" + cont_no + "' ";
			this.sessionFactory.getCurrentSession().createSQLQuery(hql).executeUpdate();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public List<Object[]> paymentdetails(String st) {
		...
		String sql = "select  Contract_qty,Contract_date, Payment_duedate,Mill_name,Grade_composition from  jcicontract  where  Contract_no='"
				+ st + "' ";
...
//			+ "                  Label_name='" + st + "'";
	...
	public List<Object[]> gradewiseqty(String st, String contractqty) {
		String sql = " select Jute_combination,(Proposed_composition*'" + contractqty
				+ "')/100 as ammount   from  jcigrade_composition where Label_name='" + st + "'";
		List<Object[]> resultList1 = (List<Object[]>) this.sessionFactory.getCurrentSession().createSQLQuery(sql)
				.list();
		return resultList1;
	}
	...
	public List<Object[]> PreviousNo(String st) {
		String sql = "SELECT Contract_No, Instrument_value, Instrument_Date FROM jcipayment_arrangement where Contract_No='"
				+ st + "'";
		List<Object[]> resultList1 = (List<Object[]>) this.sessionFactory.getCurrentSession().createSQLQuery(sql)
				.list();
		return resultList1;
	...
	public List<Object> getsumofInstrumentValue(String instValue) {
		...
		List<Object> resultListofsum = (List<Object>) this.sessionFactory.getCurrentSession().createSQLQuery(sql)
				.list();
	...
	public void remark(String remark, String con_No, int id) {
		String hql = "UPDATE  jcipayment_arrangement set Remarks =  '" + remark + "'  where Contract_No = '" + con_No
				+ "' and Payment_id= '" + id + "' ";
	...
	public List<Object[]> Millname() {
		...
		List<Object[]> millNamelist = (List<Object[]>) this.sessionFactory.getCurrentSession().createSQLQuery(sql)
				.list();
		return millNamelist;
	}
	...
	@Override
	public void deleteupdate(String st, int id) {

		String sql = "delete from jcipayment_arrangement where Payment_id='" + id + "' and Contract_No='" + st + "'";
		this.sessionFactory.getCurrentSession().createSQLQuery(sql).executeUpdate();
