...
public class Jciclaim_NominationImpl implements NominalOfficialDao {
              ...
              public String getEmailForOmo(String omofficial) {
                             ...
                             String q = "SELECT email FROM jciumt WHERE roles_name IN ('OM Role', 'RO Manager', 'HO Manager', 'HO Operation') AND employeename = '" + omofficial + "'";
              ...
              public String getEmailForFA(String FAofficial) {
                             ...
                             String q = "SELECT email FROM jciumt WHERE roles_name IN ('FA Role', 'HO Finance', 'RO Finance') AND employeename = '" + FAofficial + "'";
