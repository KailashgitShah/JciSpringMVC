...
public class verifyClaimDaoImpl implements verifyClaimDao{
	...
	String liString="\r\n"
			+ "SELECT  jciclaim_report_mill.Claim_Amount,jciclaim_report_mill.Date_of_Inspection , jciclaim_report_mill.created_by, jciclaim_report_mill.Moisture_settlement,jciclaim_report_mill.Ncv_settlement,  jciclaim_report_mill.Quality_settlement, jciclaim_report_mill.Supporting_doc, jciclaim_report_mill.Settlement_amt,jciclaimNomination.ClaimAmount, jciclaimNomination.Created_by, jciclaimNomination.Moisture_settlement, jciclaimNomination.Ncv_settlement,jciclaimNomination.Quality_settlement, jciclaimNomination.Settlement_Amt, jciclaimNomination.Supporting_doc AS ytest,jciclaimNomination.DateofInspection FROM jciclaim_report_mill  INNER JOIN jciclaimNomination  ON jciclaim_report_mill.Settlement_id = jciclaimNomination.Settlement_id WHERE jciclaim_report_mill.Settlement_id = '"+settlementId+"'";
