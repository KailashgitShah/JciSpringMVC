...
public class PdfGenerator {
	...
	public void generatePdfOfContractLetter(String contractNo, String millNameString, String millCode, Double qty,
			...
			String deliveryType, String contractDate, String filePath, String letterHeadPath, String pcsoDates,
			String refNos) throws DocumentException, IOException {
		...
		float widthOfTwoColumn[] = { columnHalfWidth * 0.78f, columnHalfWidth * 0.77f };
...
//                         System.err.println(areaAndpincode);
		...
		table.addCell(new Cell().add(new Paragraph().add(new Text("Contract No, ").setBold()).add(new Text(contractNo)))
		...
		String millNameArr[] = millNameString.split("#P#");

		String millName = millNameArr[0];
...
//		document.add(footer);
	...
	public String generatePdfOfCreditNoteDoc(String crnNo, String crnDate, String Invoice_Value, String challan_No1,
			...
			String BOS_Date, String ClientPan, List<Object[]> list, String diNo, String bosNo, String filePath)
		...
		try {
			...
			// document.setMargins(0, document.getLeftMargin(), document.getBottomMargin(),
...
//float minimumHeight = 20f;
			...
			Table contentTable36 = new Table(
					new float[] { columnWidth4, columnWidth5, columnWidth5, columnWidth6, columnWidth5 })
					.setBorder(new SolidBorder(borderWidth)).setFont(boldFont);
//float minimumHeight = 20f;
