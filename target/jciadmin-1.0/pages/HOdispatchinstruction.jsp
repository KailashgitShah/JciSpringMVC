		...
		function displayTable(rows, columns, selectedValue) {
			if (selectedValue.length > 0) {
				...
				for (var j = 1; j <= columns - 1; j++) {
					tableHTML += "<th style='font-weight: bold;'>Grade" + j
							+ "</th>";
				}
				...
				for (var i = 0; i < rows - 1; i++) {
					...
					tableHTML += "<tr><th style='font-weight: bold;'>"
							+ variety + "</th>";
				...
				tableHTML += "<td id='grand-total' class='grand-total' style='text-align: center;''><strong><span>"
						+ grandTotal + "</span></strong></td>";
		...
		$(document)
				.ready(
						function() {
							...
							$("#region")
									//DPC list auto selected when region is selected
									.on(
											"change",
											function() {
