						...
						<div class="scrollmenu">
							<table class="table table-striped table-bordered table-hover"
								...
								<tbody>
									...
									<tr>
										<td><%=i%></td>
										<td><span class="single-click" data-id="<%=row[0]%>">
												<%=row[0]%></span></td>
										<%-- <td><%= row[0] %></td> --%>
										<%-- <td><%= row[1] %></td> --%>
										<td><%=row[1]%></td>
										...
										<td style="text-align: center; color: blue"><a
											href="<%=baseIp%>/DispatchDetail/<%=row[9]%>"  target="_blank">Consignment
												Note</a></td>


										<td><a
											href="EntryofGenerationBillsupply.obj?id=<%=row[0]%>&millname=<%=row[2]%>&DPC=<%=row[7]%>">
