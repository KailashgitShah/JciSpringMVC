    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                ...
                <h1 class="page-title">H1 Bidder</h1>
            </div>
            <% 
                            ...
                            <div class="ibox-body">
                                <form name="myForm" autocomplete="off">
                                    <div class="row">
                                        <div class="col-sm-4 form-group">
                                            ...
                                            <select class="form-control" name="bidNo" id="bidNo">
                                                ...
                                                %>
                                               <option value="<%= bidref %>" data-closingdate="<%= closingdate %>">
												    <%= bidref %>
												</option> <%
                                                }
                                                %>
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-primary" type="button" onclick="result()">Publish Result</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
function parseDateString(dateString) {
             ...
             success: function(data) {
                 ...
                 if (dataArray.length > 0) {
                	 ...
                	 dataArray.sort(function(a, b) {
                		    return a[3] - b[3]; // Compare based on rank (index 3)
                		});
                     ...
                     sendToController(millNamesWithRank1);
                 }
             },
  ...
  function sendToController(millNames) {
      
      var millnames = millNames;
